...
## Updating
Push changed files to the same branch. The service worker manages the app cache automatically and replaces stale cached assets when a new deployment is detected.
